...
print("sign_md5:", sign_md5)
##############
C1_bady_text = '{"client":"pwa","timestamp":'+C1_timestamp+',"data":"'+B1_bady_aes+'","sign":"'+sign_md5+'","oauth_type":"pwa","version":"4.5.0","oauth_id":"lHXxcIXyHRHxRxyj1748116963193","mod":"index","code":"search","type":1,"key":"'+search_text+'","page":1}'
...
print("sign_md5:", sign_md5)
########
D1_bady_text = 'client=pwa&timestamp='+D1_timestamp+'&data='+C1_bady_aes+'&sign='+sign_md5


#########数据构造完成
# 网络访问
post_bodydata = D1_bady_text
